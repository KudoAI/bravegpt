...
(async () => {
    ...
    const app = {
        ...
        latestAssetCommitHash: '27282d5' // for cached messages.json
    }
    ...
    const icons = {
        ...
        pin: {
            create() {
                const svg = create.svgElem('svg', { id: 'pin-icon', width: 17, height: 17, viewBox: '0 0 16 16' })
                const svgPath = create.svgElem('path', { stroke: '',
        ...
        webCorner: {
            create() {
                const svg = create.svgElem('svg', { width: 18, height: 18, viewBox: '0 0 32 32' })
                const svgPath = create.svgElem('path', { stroke: 'none',
    ...
    const logos = {
        braveGPT: {
            ...
            create() {
                const braveGPTlogo = document.createElement('img')
                braveGPTlogo.id = 'bravegpt-logo' ; braveGPTlogo.className = 'no-mobile-tap-outline'
    ...
    const toggle = {
        ...
        autoGet() {
            ...
            log.debug(`Toggling Auto-Get ${ config.autoGetDisabled ?  'ON' : 'OFF' }...`)
            ...
            log.caller = 'toggle.autoGet()'
            log.debug(`Success! config.autoGetDisabled = ${config.autoGetDisabled}`)
        },
        ...
        reply(answer) {
            ...
            if (!appDiv.querySelector('pre')) {
                ...
                if (!env.browser.isMobile) {
                    ...
                    chevronBtn.classList.add('corner-btn')
                    chevronBtn.style.margin = '0.5px 1px 0 11px'
                ...
                aboutBtn.className = 'corner-btn' ; aboutBtn.style.marginTop = '0.8px'
                ...
                settingsBtn.className = 'corner-btn' ; settingsBtn.style.margin = '2px 9px 0 1px'
                ...
                if (answer != 'standby') {
                    ...
                    speakerBtn.className = 'corner-btn' ; speakerBtn.style.marginRight = '7px'
                ...
                if (answer != 'standby') {
                    ...
                    fontSizeBtn.className = 'corner-btn' ; fontSizeBtn.style.margin = '1px 10px 0 2px'
                ...
                // Create/append Wider Sidebar button
                    ...
                    wsbBtn.className = 'corner-btn' ; wsbBtn.style.margin = '0.151em 11px 0 0'
