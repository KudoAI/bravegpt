...
(async () => {
    ...
    const app = {
        ...
        latestResourceCommitHash: '67175b3' // for cached messages.json
    }
    ...
    const menus = {
        ...
        pin: {
            ...
            toggle(event) { // visibility
                ...
                if (!menus.pin.topPos)
                     menus.pin.topPos = ( event.clientY || event.touches?.[0]?.clientY ) < 195 ? 58 : -80
        ...
        appStyle() {
            ...
            app.styles.innerText = (
              ...
              + `.${app.slug}-header-btn:hover svg { /* zoom header button on hover */
                    ...
                    ${ config.fgAnimationsDisabled || env.browser.isMobile ? ''
                        : 'width: 128.5% ; height: 128.5% ; transform: translate(-9%, -9%)' }}`
              ...
              + ( // Markdown styles
                  ...
                  + `#${app.slug} > pre ol { margin: -15px 0 -6px 7px ; }`
              ...
              // Anchor Mode styles
              + `#${app.slug}.anchored { position: fixed ; bottom: -7px ; right: 35px ; width: 441px ; z-index: 8888 }
    ...
    const toggle = {
        ...
        // * stateOrEvent: 'on'|'off' or button `event`
            ...
            tooltipDiv.style.top = `${
              ...
              : rects.btn.top - rects.appDiv.top -36 - ( stateOrEvent.currentTarget.closest('code') ? 4 : 0 )
            }px`
    ...
    function restoreAppDiv() {
        ...
        if (appDiv.querySelector('pre')) show.replyCornerBtns()
