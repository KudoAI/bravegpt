...
BraveGPT relies on code from the powerful [chatgpt.js](https://github.com/chatgptjs/chatgpt.js) library Copyright (c) 2023 Adam Lui & 冯不游 under the MIT license.
