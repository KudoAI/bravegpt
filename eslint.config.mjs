    ...
    { ignores: ['**/*cache*', '**/*.min.{js,mjs}', '**/package-lock.json'] },
    {
        ...
        languageOptions: {
            ...
            globals: {
                ...
                buttons: 'writable', chatgpt: 'readonly', CryptoJS: 'readonly', css: 'readonly', dom: 'readonly',
                env: 'writable', feedback: 'readonly', fontSizeSlider: 'writable', get: 'readonly',
                GM_cookie: 'readonly', gmToolbarMenu: 'writable', hljs: 'readonly', icons: 'readonly', ipv4: 'readonly',
                ...
                Tone: 'readonly', tooltip: 'writable', ui: 'readonly', update: 'readonly', updateCheck: 'readonly',
                userscript: 'readonly'
            }
        },
